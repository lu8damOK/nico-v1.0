 ...
 * @description:  Gestión de variables, constantes, listas, matrices y archivos
 */
#include "nico.h"
...
int num_variables = 0, num_variables_sin_signo = 0, num_variables_decimal = 0;
int num_variables_decimal_sin_signo = 0, num_variables_caracter = 0, num_variables_caracter_sin_signo = 0, num_texto_vars = 0;
...
int agregar_texto_var(const char *nombre, const char *valor) {
    ...
    strncpy(texto_vars[num_texto_vars].nombre, nombre, MAX_NOMBRE - 1);
    texto_vars[num_texto_vars].nombre[MAX_NOMBRE - 1] = '\0';
    strncpy(texto_vars[num_texto_vars].valor, valor ? valor : "", MAX_TEXTO_LEN - 1);
    texto_vars[num_texto_vars].valor[MAX_TEXTO_LEN - 1] = '\0';
